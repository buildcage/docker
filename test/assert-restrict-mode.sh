...
assert_log_contains BLOCKED "blocked.example.com:443"
assert_log_contains BLOCKED "blocked.example.com:80"
assert_log_contains BLOCKED "blocked.example.com:8443"
assert_log_contains BLOCKED "blocked.example.com:8080"
echo ""
