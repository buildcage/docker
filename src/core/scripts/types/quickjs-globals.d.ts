 ...
 * src/core/scripts, src/core/lib, docker/explicit/scripts, docker/inspect/scripts)
 * — not a general QuickJS type definition. This file must only ever be visible to
